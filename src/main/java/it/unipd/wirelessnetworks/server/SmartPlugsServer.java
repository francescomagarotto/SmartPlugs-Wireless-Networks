...
public class SmartPlugsServer extends WebSocketServer {
	...
	public void onMessage(WebSocket connection, String message) {
        ...
        if(clients.keySet().contains(clientID)) {
            // we are here the message that raised onMessage came from a client which IS connected to the power grid
            disconnectClientFromGrid(clientID);
        } else {
            // we are here the message that raised onMessage came from a client which ISN'T connected to the power grid
